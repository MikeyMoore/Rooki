def grid_translate(x_coord, y_coord):
	...
	if(x < 1200 and x > 950 and y < 1520 and y > 1355):
		#"a1"
		return [56]
	elif(x < 950 and x > 800 and y < 1520 and y > 1355):
		#"a2"
		return [48]
	elif(x < 800 and x > 700 and y < 1520 and y > 1355):
		#"a3"
		return [40]
	elif(x < 700 and x > 540 and y < 1520 and y > 1355):
		#"a4"
		return [32]
	elif(x < 540 and x > 400 and y < 1520 and y > 1355):
		#"a5"
		return [24]
	elif(x < 400 and x > 270 and y < 1520 and y > 1355):
		#"a6"
		return [16]
	elif(x < 270 and x > 150 and y < 1520 and y > 1355):
		#"a7"
		return [8]
	elif(x < 150 and y < 1520 and y > 1355):
		#"a8"
		return [0]
	elif(x < 1200 and x > 950 and y < 1355 and y > 1225):
		#"b1"
		return [57]
	elif(x < 950 and x > 800 and y < 1355 and y > 1225):
		#"b2"
		return [49]
	elif(x < 800 and x > 700 and y < 1355 and y > 1225):
		#"b3"
		return [41]
	elif(x < 700 and x > 540 and y < 1355 and y > 1225):
		#"b4"
		return [33]
	elif(x < 540 and x > 400 and y < 1355 and y > 1225):
		#"b5"
		return [25]
	elif(x < 400 and x > 270 and y < 1355 and y > 1225):
		#"b6"
		return [17]
	elif(x < 270 and x > 150 and y < 1355 and y > 1225):
		#"b7"
		return [9]
	elif(x < 150 and y < 1355 and y > 1225):
		#"b8"
		return [1]
	elif(x < 1200 and x > 950 and y < 1225 and y > 1100):
		#"c1"
		return [58]
	elif(x < 950 and x > 800 and y < 1225 and y > 1100):
		#"c2"
		return [50]
	elif(x < 800 and x > 675 and y < 1225 and y > 1100):
		#"c3"
		return [42]
	elif(x < 675 and x > 540 and y < 1225 and y > 1100):
		#"c4"
		return [34]
	elif(x < 540 and x > 400 and y < 1225 and y > 1100):
		#"c5"
		return [26]
	elif(x < 400 and x > 270 and y < 1225 and y > 1100):
		#"c6"
		return [18]
	elif(x < 270 and x > 150 and y < 1225 and y > 1100):
		#"c7"
		return [10]
	elif(x < 150 and y < 1225 and y > 1100):
		#"c8"
		return [2]
		...
		#"g1"
		return [62]
	elif(x < 950 and x > 800 and y < 690 and y > 555):
		#"g2"
		return [54]
	elif(x < 800 and x > 700 and y < 690 and y > 555):
		#"g3"
		return [46]
	elif(x < 700 and x > 540 and y < 690 and y > 555):
		#"g4"
		return [38]
	elif(x < 540 and x > 400 and y < 690 and y > 555):
		#"g5"
		return [30]
	elif(x < 400 and x > 270 and y < 690 and y > 555):
		#"g6"
		return [22]
	elif(x < 270 and x > 150 and y < 690 and y > 555):
		#"g7"
		return [14]
	elif(x < 150 and y < 690 and y > 555):
		#"g8"
		return [6]
	elif(x < 1200 and x > 950 and y < 555 and y > 400):
		#"h1"
		return [63]
	elif(x < 950 and x > 800 and y < 555 and y > 400):
		#"h2"
		return [55]
	elif(x < 800 and x > 700 and y < 555 and y > 400):
		#"h3"
		return [47]
	elif(x < 700 and x > 540 and y < 555 and y > 400):
		#"h4"
		return [39]
	elif(x < 540 and x > 400 and y < 555 and y > 400):
		#"h5"
		return [31]
	elif(x < 400 and x > 270 and y < 555 and y > 400):
		#"h6"
		return [23]
	elif(x < 270 and x > 150 and y < 555 and y > 400):
		#"h7"
		return [15]
	elif(x < 150 and y < 555 and y > 400):
		#"h8"
		return [7]
	else:
